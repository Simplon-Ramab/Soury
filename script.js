...
function verifieReponse5a() {
  var blocf5a=document.getElementById('blocf5a');
  var compteur5a = document.getElementById('compteur5a');
...
// $(document).ready(function(){
//     $("#user").click(function(){
//         $("#notes").slideToggle("slow", function(){
//           $("#notes").click(function(){
//           ("#blocquizz #blocquizzf5 #blocquizz5a #blocquizz5m #blocquizzf #blocquizzm").hide();
//         });
//         });
//     });
//     });
